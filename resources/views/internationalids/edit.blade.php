            ...
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0);">Update ID</a>
                        </li>
                    </ol>
                </div>
            </div>
...
@section('content')
	<div class="content-body">
		<div class="card">
			<div class="card-body">
				<form action="{{ route('internationalids.update', ['internationalid' => encryptParams($internationalId->id)]) }}" method="POST">
					@csrf
					@method('PUT')
					...
					<div class="mb-1">
						...
						<input type="text" id="name" name="name"
						       ...
						       aria-label="ID Name" value="{{ $internationalId->name }}" minlength="3" maxlength="50" />
						@error('name')
