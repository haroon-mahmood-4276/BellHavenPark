...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'booking-sources.create') }}
@endsection

@section('page-title', 'Create Booking Source')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Booking Source</h2>
        {{ Breadcrumbs::render('booking-sources.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('booking-sources.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('booking-sources.index') }}" class="btn btn-danger w-100 ">
