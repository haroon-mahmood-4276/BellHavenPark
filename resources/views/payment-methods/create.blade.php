...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'payment-methods.create') }}
@endsection

@section('page-title', 'Create Method')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Method</h2>
        {{ Breadcrumbs::render('payment-methods.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('payment-methods.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('payment-methods.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('payment-methods.form-fields-js', ['from' => 'create'])
@endsection
