...
@section('title', 'Add New Booking Source')
    ...
    <div class="content-header row my-1">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Add New Booking Source</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add New Booking Source</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
@section('content')
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('booking_sources.store') }}" method="POST">
                    @csrf
                    <div class="row mb-1">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                placeholder="Booking Source Name" aria-label="Booking Source Name" value="{{ old('name') }}"
