...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'booking-taxes.edit', $booking_tax->id) }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('booking-taxes.edit', $booking_tax->id) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('booking-taxes.update', ['booking_tax' => $booking_tax->id]) }}"
