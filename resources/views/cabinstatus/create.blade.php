...
@section('title', 'Add New Cabin Status')
    ...
    <div class="content-header row my-1">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Add New Cabin Status</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add New Cabin Status</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
@section('content')
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('cabin_statuses.store') }}" method="POST">
                    @csrf
                    <div class="row mb-1">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                placeholder="Cabin Status Name" aria-label="Cabin Status Name" value="{{ old('name') }}"
