...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'international-ids.edit', encryptParams($internationalId->id)) }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('international-ids.edit', encryptParams($internationalId->id)) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('international-ids.update', ['id' => encryptParams($internationalId->id)]) }}"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                {{ view('international-ids.form-fields', ['paymentMethod' => $internationalId]) }}
