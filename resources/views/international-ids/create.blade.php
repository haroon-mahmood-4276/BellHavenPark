...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'international-ids.create') }}
@endsection

@section('page-title', 'Create ID')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create ID</h2>
        {{ Breadcrumbs::render('international-ids.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('international-ids.store') }}" method="POST" enctype="multipart/form-data">
