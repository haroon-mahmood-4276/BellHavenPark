    ...
    <div class="content-header row my-1">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Edit Cabin Type</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit Cabin Type</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="content-body">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('cabin_types.update', ['cabin_type' => encryptParams($cabinType->id) ]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-1">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Cabin Type Name" aria-label="Cabin Type Name" value="{{ $cabinType->name }}" minlength="3"
                            maxlength="50" />
                        @error('name')
                    ...
                    {{-- <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" id="rate" name="rate"
                            ...
                            placeholder="Rate" aria-label="Rate" value="{{ $cabinType->rate }}"
