    ...
    <div class="content-header row my-1">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Edit Payment Method</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Edit Payment Method</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
@section('content')
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('payment_methods.update', ['id' => encryptParams($paymentMethod->id)]) }}" method="POST">
                    @method('PUT')
                    @csrf

                    {{ view('paymentmethods.form_fields', ['paymentMethod' => $paymentMethod]) }}
