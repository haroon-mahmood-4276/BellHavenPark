    ...
    <div class="content-header row my-1">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Add New Customer</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="javascript:void(0);">Add New Customer</a>
                            </li>
                        </ol>
                    </div>
                </div>
...
@section('content')
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('customers.store') }}" class="tenants-form" method="POST">
                    @csrf
                    <div class="row mb-1">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="last_name" name="last_name"
                                ...
                                placeholder="Last Name" aria-label="Last Name" value="{{ old('last_name') }}" min="3"
                                max="50" />
                            @error('last_name')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row mb-1">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="email" name="email"
                                ...
                                placeholder="Email" aria-label="Email" value="{{ old('email') }}" min="3"
                                max="50" />
                            @error('email')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="dob" name="dob"
                                ...
                                placeholder="{{ now()->format('F j, Y') }}" value="{{ old('dob') }}" onfocus="openFlatPicker()" />
                            @error('dob')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="telephone" name="telephone"
                                ...
                                placeholder="Telephone" aria-label="Telephone" value="{{ old('telephone') }}"
                                min="1" max="20"
                            ...
                            <select class="select2-size-lg form-select @error('id_type') is-invalid @enderror"
                                ...
                                @foreach ($id_types as $id_type)
                                    <option value="{{ $id_type->id }}"
                                        {{ old('id_type') == $id_type->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-1">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="id_details" name="id_details"
                                ...
                                placeholder="ID Details" aria-label="id_details" value="{{ old('id_details') }}"
                                min="3" max="50" />
                            @error('id_details')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" id="id_address" name="id_address"
                                ...
                                placeholder="ID Address" aria-label="id_address" value="{{ old('id_address') }}"
                                min="3" max="50" />
                            @error('id_address')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="row mb-1">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <textarea type="text" id="comments" name="comments"
                                ...
                                aria-label="comments" rows="5">{{ old('comments') }}</textarea>
                            @error('comments')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <textarea type="text" id="address" name="address"
                                ...
                                aria-label="address" rows="5">{{ old('address') }}</textarea>
                            @error('address')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-1">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="text" id="referenced_by" name="referenced_by"
                                ...
                                value="{{ old('referenced_by') }}" min="1" max="255" />
                            @error('referenced_by')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-3 col-md-3 col-sm-12">
                                                    ...
                                                    <input type="text" id="tenant_dob" name="tenant_dob"
                                                        class="form-control form-control-lg dob-human-friendly @error('tenant-dob') is-invalid @enderror"
                                                        placeholder="{{ now()->format('F j, Y') }}" onfocus="openFlatPicker()" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
