...
@section('PageCSS')
<link rel="stylesheet" type="text/css" href="{{ asset('public_assets/admin') }}/vendors/css/calendars/fullcalendar.min.css">

<link rel="stylesheet" type="text/css" href="{{ asset('public_assets/admin') }}/css/pages/app-calendar.min.css">
@endsection
            ...
            <div class="app-calendar overflow-hidden border">
                <div class="row g-0">
                    ...
                    <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
                        ...
                        <div class="mt-auto">
                            <img src="{{ asset('public_assets/admin') }}/images/pages/calendar-illustration.png" alt="Calendar illustration" class="img-fluid" />
                        </div>
                    </div>
                    <!-- /Sidebar -->
                    <!-- Calendar -->
...
@section('PageJS')
<script src="{{ asset('public_assets/admin') }}/vendors/js/calendar/fullcalendar.min.js"></script>
<script src="{{ asset('public_assets/admin') }}/vendors/js/extensions/moment.min.js"></script>

<script src="{{ asset('public_assets/admin') }}/js/scripts/pages/app-calendar-events.min.js"></script>
<script src="{{ asset('public_assets/admin') }}/js/scripts/pages/app-calendar.min.js"></script>
@endsection
