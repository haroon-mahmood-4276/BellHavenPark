            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12 mb-30">
                ...
                @elseif (session()->has('success'))
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <h4 class="alert-heading"><i data-feather='check-circle' class="me-50"></i>Success!
                        </h4>
                        <div class="alert-body">
                            {{ session()->get('success') }}
                        </div>
                ...
                @elseif (session()->has('warning'))
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <h4 class="alert-heading"><i data-feather="alert-triangle" class="me-50"></i>Warning!
                        </h4>
                        <div class="alert-body">
                            {{ session()->get('warning') }}
                        </div>
                ...
                @elseif (session()->has('danger'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <h4 class="alert-heading"><i data-feather="alert-circle" class="me-50"></i>Error!
                        </h4>
                        <div class="alert-body">
                            {{ session()->get('danger') }}
                        </div>
