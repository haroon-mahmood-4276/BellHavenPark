...
isRtl && (direction = "rtl"), document.addEventListener("DOMContentLoaded", function () {
    {
        const f = document.getElementById("calendar"),
            ...
            x = document.querySelector("#eventStartDate"),
        ...
        let a, l = events,
            r = !1,
            e;
        const B = new bootstrap.Offcanvas(h);
        ...
        function s() {
            ...
            e.setAttribute("data-bs-toggle", "sidebar"), e.setAttribute("data-overlay", ""), e.setAttribute("data-target", "#app-calendar-sidebar"), e.insertAdjacentHTML("beforeend", '<i class="ti ti-menu-2 ti-sm"></i>')
        }
        ...
        function p() {
            D.value = "", M.value = "", x.value = "", q.value = "", A.value = "", Y.checked = !1, P.val("").trigger("change"), F.value = ""
        }
        i.render(), s(), u = document.getElementById("eventForm"), FormValidation.formValidation(u, {
            ...
            S && (S.innerHTML = "Add Event"), E.innerHTML = "Add", E.classList.remove("btn-update-event"), E.classList.add("btn-add-event"), k.classList.add("d-none"), g.classList.remove("show"), b.classList.remove("show")
            ...
            i.changeView(i.view.type, moment(e[0]).format("YYYY-MM-DD")), s(), g.classList.remove("show"), b.classList.remove("show")
        })
    }
});
