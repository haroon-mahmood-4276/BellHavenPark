...
class CabinAssetService implements CabinAssetInterface
{
    private function model()
    {
        return new CabinAsset();
    }
    ...
    public function store($inputs)
    {
        $returnData = DB::transaction(function () use ($inputs) {
            $data = [
                ...
                "serviceable" => $inputs["serviceable"],
                "expireable" => $inputs["expireable"],
            ];
