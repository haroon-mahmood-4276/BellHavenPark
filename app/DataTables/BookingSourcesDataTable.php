...
class BookingSourcesDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\BookingSource $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BookingSource $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (auth()->user()->can('booking-sources.create')) {
        ...
        if (auth()->user()->can('booking-sources.export')) {
