...
class BookingTaxesDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('booking-taxes.actions', ['id' => $row->id]);
            })
            ->setRowId('id')
            ->rawColumns($columns);
    }
     ...
     *
     * @param \App\Models\BookingTax $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BookingTax $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (auth()->user()->can('booking-taxes.create')) {
        ...
        if (auth()->user()->can('booking-taxes.export')) {
        ...
        if (auth()->user()->can('booking-taxes.destroy')) {
    ...
    {
        return 'BookingTaxes_' . date('YmdHis');
    }
