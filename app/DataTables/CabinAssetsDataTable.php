...
class CabinAssetsDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('installable', function ($model) {
                return editBooleanColumn($model->installable);
            })
            ->editColumn('serviceable', function ($model) {
                return editBooleanColumn($model->serviceable);
            })
            ->editColumn('expireable', function ($model) {
                return editBooleanColumn($model->expireable);
            })
            ->editColumn('updated_at', function ($model) {
                return editDateTimeColumn($model->updated_at);
            })
            ->editColumn('actions', function ($model) {
                return view('cabins.assets.actions', ['id' => $model->id]);
            })
            ->setRowId('id')
     ...
     *
     * @param \App\Models\CabinAsset $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CabinAsset $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (auth()->user()->can('cabins.assets.create')) {
        ...
        if (auth()->user()->can('cabins.assets.export')) {
        ...
        if (auth()->user()->can('cabins.assets.destroy')) {
    ...
    protected function getColumns(): array
    {
        ...
        $columns = [
            $checkColumn,
            Column::make('name')->title('Cabin Assets')->addClass('text-nowrap text-center align-middle'),
            Column::make('slug')->title('Slug')->addClass('text-nowrap text-center align-middle'),

            Column::make('installable')->addClass('text-nowrap text-center align-middle'),
            Column::make('serviceable')->addClass('text-nowrap text-center align-middle'),
            Column::make('expireable')->addClass('text-nowrap text-center align-middle'),
    ...
    {
        return 'CabinAssets_' . date('YmdHis');
    }
